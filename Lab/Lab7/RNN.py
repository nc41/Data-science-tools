...
with tf.Session() as sess:
    ...
    for epoch in range(numTrainingIters):
        ...
        if epoch >= 9990:
            avgLoss += _totalLoss
            numOfCorrectness += numCorrect
        print("Step", epoch, "Loss", _totalLoss,
              "Correct", numCorrect, "out of", batchSize)

print("Average loss for the last 10 mini-batches is", avgLoss / 10,
      "average correct labels is", numOfCorrectness / 10, "out of", batchSize)
